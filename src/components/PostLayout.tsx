...
export default function PostLayout({
  ...
  return (
    <Layout>
      <BasicMeta url={`/missions/${slug}`} title={title} keywords={keywords} description={description} />
      <TwitterCardMeta url={`/missions/${slug}`} title={title} description={description} />
      <OpenGraphMeta url={`/missions/${slug}`} title={title} description={description} />
      <JsonLdMeta
        url={`/missions/${slug}`}
        title={title}
        keywords={keywords}
